    ...
    >
      ...
      >
        ...
        <div className={`flex justify-center`}>
          <button
            className={`px-3 py-2 mr-6 rounded-lg dark:bg-gray-700 bg-gray-100 dark:hover:bg-gray-600 bg-gray-200 font-semibold text-white transition duration-200 ease-in-out focus:ring-4 ring-blue-500 ring-opacity-60`}
