        ...
        <div className="w-full sm:w-3/6 flex">
          {!submitQuiz && (
            <div className="w-8/12 flex sm:justify-end justify-between">
              {firstQuestion ? (
                <button
                  className={`px-6 py-2 rounded-lg dark:bg-gray-700 bg-gray-100 dark:hover:bg-gray-600 bg-gray-200 font-semibold dark:text-gray-200 transition duration-200 ease-in-out focus:ring-4 ring-blue-500 ring-opacity-60`}
                  onClick={() =>
                    dispatchSubmitQuiz({
