...
export const QuizCard: React.FC<{ quiz: Quiz }> = ({ quiz }) => {
  ...
  return (
    <article
      className="gradient-bg px-0 py-4  rounded-3xl w-300 sm:w-250 text-white cursor-pointer hover:shadow-xl hover:scale-105 transition duration-300 ease-in-out"
